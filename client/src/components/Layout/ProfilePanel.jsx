  ...
  const { authUser, isUpdatingProfile, isUpdatingPassword } = useSelector(
    ...
    const handleUpdateProfile = () => {
      ...
      const handleUpdatePassword = () => {
        ...
        formDate.append("currentPassword", currentPassword);
        formDate.append("newPassword", newPassword);
        formDate.append("confirmNewPassword", confirmNewPassword);
      ...
      <div className="fixed right-0 top-0 w-96 z-50 h-full glass-panel animate-slide-in-right overflow-y-auto">
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-6">
              <img src={authUser?.avatar?.url || "/avatar-holder.avif"} 
              alt={authUser?.name} 
            ...
            {/* UPDATE PROFILE FORM */}
             {
              authUser && (
                <div className="space-y-4 mb-8">
                  ...
                  text-muted-foreground cursor-pointer w-max text-sm">
                    <Upload className="h-4 w-4 text-primary" />
                    <span className="text-sm text-primary">Change Avatar</span> 
                    ...
                    className="flex justify-center items-center space-x-3 p-3 rounded-lg
                    glass-card hover:glow-on-hover animate-smooth group w-full ">
                      {
                        isUpdatingProfile ? (<>
          ...
          {/* UPDATE PASSWORD FORM */}
            <div className="space-y-4 mb-8">
                  ...
                  className="text-muted-foreground text-xs flex items-center gap-1">
                    ...
                    {showPassword ? "Hide Passwords" : "Show Passwords"} Passwords
                    </button>
              ...
              className="my-6 flex items-center space-x-3 p-r rounded-lg glass-card hover:glow-on-hover
               text-destructive hover:text-destructive-foreground animate-smooth group w-full ">
