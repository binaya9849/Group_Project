...
import { Loader, Star, ShoppingCart, Heart, Share2 } from 'lucide-react';
          ...
          <div>
            <div className="mb-4">
              <div className="flex space-x-2 mb-4">
                ...
                {product.ratings >= 4.5 && (
                  <span className="px-2 py-1 bg-gradient-to-r from-yellow-400 to-orange-500 
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <span className="font-medium text-foreground">{product.ratings}</span>
          ...
          <div className="p-6">
            {
              ...
              {
                activeTab === "reviews" && (
                  <ReviewsContainer productReviews={productReviews} product={product} />
                )
              }
