...
const Profile = () => {
  ...
  return <> 
  <main className="p-[10px] pl-[17rem] w- Full">
    {/*Header */}
    <div className="flex -1 md:p-6 mb:pb-0">
      ...
      {/* UPDATE PROFILE SECTION */}
          ...
          className="flex justify-center gap-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 mt-4transition-all"
