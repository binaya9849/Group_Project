...
export const getUser = createAsyncThunk("_/getUser", async (data, thunkAPI) => {
  try {
    ...
    return thunkAPI.rejectWithValue(error.response.data.message || "Failed to get user data");
    
  }
});

export const logout = createAsyncThunk("_/logout", async (data, thunkAPI) => {
 try {
...
export const updateProfile = createAsyncThunk("auth/me/update", 
  async (data, thunkAPI) => {
  try {
